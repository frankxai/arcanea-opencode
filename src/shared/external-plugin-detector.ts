...
⚠️  Both oh-my-opencode and ${pluginName} listen to session.idle events.
   ...
   arcanea-opencode's session-notification has been auto-disabled.

   To use arcanea-opencode's notifications instead, either:
   1. Remove ${pluginName} from your opencode.json plugins
   2. Or set "notification": { "force_enable": true } in arcanea-opencode.json`
}
